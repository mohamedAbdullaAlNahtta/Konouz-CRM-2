...
// ///////////////////////////////////////////////////////////////
 ...
 `u`.`Open_terrace_Area`,
 `u`.`Usufruct_type`,
 `u`.`usufruct_meter_price` as `UsuID`,
...
if (isset($_POST['submit'])) {
    ...
    // $Unit_No_edite = $_POST['Unit_No'];
    // $Build_No_edite = $_POST['Build_No'];
    // $Project_ID_edite = $_POST['Project_ID'];
    ...
    $Basic_Meter_Price_edite = $_POST['Basic_Meter_Price_edite'];
    ...
    $usufruct_meter_price_edite = $_POST['usufruct_meter_price_edite'];
    //$Usufruct_Price = $_POST['Usufruct_Price'];
    $Net_Area_edite = $_POST['Net_Area_edite'];
    $Load_Ratio_edite = $_POST['Load_Ratio_edite'];
    // $Status_ID_edite = $_POST['Status_ID'];
    //$maintenance_pct = $_POST['maintenance_pct'];
    $finishing_level_new_edite = $_POST['finishing_level_new_edite'];
    $Rooms_Desc_edite = $_POST['Rooms_Desc_edite'];
    
    // escaping variables
    // $Unit_No_edite = $database->escape_string($Unit_No);
    // $Build_No_edite = $database->escape_string($Build_No);
    // $Project_ID_edite = $database->escape_string($Project_ID);
    $floor_id_edite = $database->escape_string($floor_id_edite);
    $Raw_ID_edite = $database->escape_string($Raw_ID_edite);
    $Pos_ID_edite = $database->escape_string($Pos_ID_edite);
    $Unit_Area_edite = $database->escape_string($Unit_Area_edite);
    $Basic_Meter_Price_edite = $database->escape_string($Basic_Meter_Price_edite);
    //$Unit_Basic_Price = $database->escape_string($Unit_Basic_Price);
    $Roof_Area_edite = $database->escape_string($Roof_Area_edite);
    $Garden_Area_edite = $database->escape_string($Garden_Area_edite);
    $Open_terrace_Area_edite = $database->escape_string($Open_terrace_Area_edite);
    $Usufruct_type_edite = $database->escape_string($Usufruct_type_edite);
    $usufruct_meter_price_edite = $database->escape_string($usufruct_meter_price_edite);
    //$Usufruct_Price = $database->escape_string($Usufruct_Price);
    $Net_Area_edite = $database->escape_string($Net_Area_edite);
    $Load_Ratio_edite = $database->escape_string($Load_Ratio_edite);
    //$maintenance_pct = $database->escape_string($maintenance_pct);
    $finishing_level_new_edite = $database->escape_string($finishing_level_new_edite);
...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index?module=Unites">Units <?php var_dump($units_get_Layout_With_dimensions); ?></a></li>
                        ...
                        <div class="tab-pane" id="UsufructAttachment" role="tabpanel">
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    ...
                                    <div class="col-md-6">
                                        <input type="file" name="Parking" id="input-file-now" class="dropify" data-default-file="<?php echo 'uploads/'.htmlentities($Parking_FileLocation); ?>"/>
