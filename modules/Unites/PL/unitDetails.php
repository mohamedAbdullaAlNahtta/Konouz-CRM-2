...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6 col-4 align-self-center">
            ...
            <button onclick="location.href='index?module=Activities&create=true&unitId=<?php echo htmlentities($unitDetailsID)?>'" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i> New Activity </button>
        </div>
    </div>
    <!-- ============================================================== -->
