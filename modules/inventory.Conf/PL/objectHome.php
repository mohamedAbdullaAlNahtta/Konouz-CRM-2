...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-6 col-4 align-self-center">
            ...
            <button onclick="location.href='index?module=Inventory.Conf&tableName=<?php echo $tableName; ?>&objectCreate=true'" class="btn pull-right hidden-sm-down btn-success"><i class="mdi mdi-plus-circle"></i> Create</button>
        </div>
    </div>
    <!-- ============================================================== -->
...
for ($row = 0;$row < $objectRowCount;$row++)
{
    ...
    echo "<td>
    <a href='index?module=Inventory.Conf&tableName={$tableName}&objectEditeId=".$objectdata[$row][$columns[0]]."' data-toggle='tooltip' data-original-title='Edit'> <i class='fa fa-pencil text-inverse m-r-10'></i></a>
    <a href='index?module=Inventory.Conf&tableName={$tableName}&objecthome=true&deleteObjectId=".$objectdata[$row][$columns[0]]."' data-toggle='tooltip' data-original-title='delete'> <i class='fa fa-trash'></i></a></td> </tr>";
}
